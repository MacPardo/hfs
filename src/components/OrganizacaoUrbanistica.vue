  ...
  <div class="container mission-section">
    <div class="row">
      <div class="col-lg-6">
        ...
        <hr />
        <p>Nessa época, a praça era considerada como centro e a igreja como o prédio mais 
          importante da região. Junto à igreja ficava a residência dos padres, o colégio, as 
          oficinas, o cemitério. As casas dos indígenas, contornavam a praça.
          Essas casas eram uniformes, feitas de pedra, com <b>alpendres</b> e cobertas por telhas.</p>
        <p>Os indígenas dormiam em redes de algodão, que serviam também de cadeira, quando não 
          estavam em cadeiras de madeira ou ainda de <b>cócoras</b> ou no chão.</p>
        <p>Num dos lados da igreja estava o cemitério e a casa grande, chamada de <b>Cotiguaçu</b>, 
          onde abrigavam-se as viúvas, as mulheres sozinhas e os órfãos.</p>
        <p>No outro lado da igreja ficava o colégio, onde era ministrado o ensino onde
          só estudavam os meninos filhos de caciques e administradores; as meninas
